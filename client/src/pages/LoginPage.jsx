...
import { ShipWheelIcon, Eye, EyeOff, Users, MessageCircle, Globe, Star, Lock, Mail, Sparkles, MessageSquare, Languages, Globe2 } from "lucide-react";
                ...
                {error && (
                  <div className="mb-8 p-4 bg-red-50/80 border border-red-200 rounded-2xl backdrop-blur-sm animate-shake">
                    <div className="flex items-center gap-3 text-red-700">
                      ...
                      <span className="text-sm font-medium">{error.response?.data?.message || "Login failed"}</span>
                    </div>
                  </div>
                )}
                ...
                <form onSubmit={handleLogin} className="space-y-7">
                  ...
                  >
                    ...
                    {isPending ? (
                      ...
                      <>
                        <span>Continue to Conversa</span>
            ...
            <div className="w-full max-w-2xl space-y-12">
              ...
              <div className="text-center lg:text-left space-y-8">
                ...
                <p className="text-xl lg:text-2xl text-slate-600 leading-relaxed max-w-2xl">
                  Immerse yourself in real conversations with native speakers. 
                  Build confidence and fluency faster than traditional methods.
                </p>
              </div>
                ...
                <div className="bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-cyan-500/10 rounded-3xl p-8 border border-white/60 backdrop-blur-sm shadow-2xl shadow-blue-200/20">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-semibold text-slate-800">Live conversation in progress</div>
                      <div className="text-xs text-slate-600">Practice Spanish with Maria from Madrid</div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="bg-white rounded-2xl rounded-tl-none p-4 shadow-sm">
                        <p className="text-slate-700">¡Hola! How's your Spanish practice going?</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 justify-end">
                      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl rounded-tr-none p-4 shadow-sm">
                        <p className="text-white">Much better! Your tips helped me a lot. 🚀</p>
                      </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-white/60 shadow-xl relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-slate-700 text-lg italic mb-6 leading-relaxed">
                    "I went from beginner to conversational in Spanish in just 3 months! The real-time practice with native speakers made all the difference."
                  </p>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl shadow-lg"></div>
                    <div>
                      <p className="text-slate-900 font-bold text-lg">Sarah Chen</p>
                      <p className="text-slate-500">Learned 3 languages on Conversa</p>
                    </div>
                  </div>
                </div>
              </div>
